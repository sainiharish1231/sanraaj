...
export const ApplyNow: NextPage<IApplyNow.IProps, IApplyNow.InitialProps> = ({
  t,
  i18n,
}) => {
...
ApplyNow.getInitialProps = async (
  ctx: ReduxNextPageContext
): Promise<IApplyNow.InitialProps> => {
  return { namespacesRequired: ["common"] };
};

export default withTranslation("common")(ApplyNow);
