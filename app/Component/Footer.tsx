...
const Footer: React.FC = () => {
  ...
  return (
    <div className="relative text-[#ffff]  bg-deep-purple-accent-400 bg-[#101118] ">
      <svg
      ...
      <div className="flex flex-col items-center text-center text-surface">
        <div className="container pt-9  flex  justify-center  flex-col sm:flex-row sm:justify-between">
          <div className="mb-6   flex justify-center  items-centerspace-x-2">
            ...
            <div className={` flex  flex-col justify-center items-center `}>
              ...
              <h4 className="text-[#ffff]">Software Solutions</h4>
            </div>
          </div>
        ...
        <div className="flex flex-col w-full text-[#ffff]  items-center text-center text-surface">
          <div className="container   flex flex-col sm:flex-row gap-5 justify-between">
            <div>
              <h3>QUICK LINKS</h3>
            ...
            <div className="text-[#ffff]">
              <h3>CONTACT US</h3>
              <div className=" flex flex-row  text-[#ffff] items-center cursor-pointer mt-5 justify-center gap-5">
                <div className="h-7 w-7  flex bg-white rounded-full  text-[#ffff] justify-center items-center">
                  <Phone className="h-10 w-10  fill-[#7910f2] " />
                </div>
                <div className="flex justify-center items-center text-[#ffff] hover:text-[#7910f2]">
                  <h6>+91 8769938925</h6>
                </div>
              </div>
