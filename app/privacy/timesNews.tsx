...
export const Privacy: NextPage<IPrivacy.IProps, IPrivacy.InitialProps> = ({
  t,
  i18n,
}) => {
  return (
    <DetailsLayout title="Privacy Policy">
      <Container>
        <ContentContainer>
          ...
          <Paragraph>
            At Times News, accessible from Play Store, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Times News and how we use it.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            they shared and/or collect in Times News. This policy is not
          ...
          <Paragraph>
            ...
            disclosure of your information, at anytime, by mailing us at
            raj@sanraaj.com or contacting us at: Birol, Nawalgarh(Jhunjhunu).
          </Paragraph>

          <H2 className="details-heading">Log Files</H2>
          <Paragraph>
            Times News follows a standard procedure of using log files. These
            files log visitors when they visit app. All hosting companies do
          ...
          <Paragraph>
            When you click on links on our app, they may direct you away from
          ...
          <Paragraph>
            Times News's Privacy Policy does not apply to other advertisers
            ,websites or app. Thus, we are advising you to consult the
          ...
          <Paragraph>
            ...
            effect immediately upon their posting on the app. If we make
          ...
          <Paragraph>
            Times News does not knowingly collect any Personal Identifiable
            Information from children under the age of 13. If you think that
            your child provided this kind of information on our app, we strongly
          ...
          <Paragraph>
            ...
            more information contact our Privacy Compliance Officer by mail
            raj@sanraaj.com.
          </Paragraph>
        </ContentContainer>
      </Container>
