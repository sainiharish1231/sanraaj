...
export async function generateMetadata({ params }: any): Promise<Metadata> {
  ...
  const title = truncateText(singleNews.title || "Untitled", 57);
  ...
  return {
    ...
    keywords: [`${singleNews.keywords} | Times News , times-news`],
    openGraph: {
      images: [singleNews.image_url],
    },
    icons: {
      icon: singleNews.image_url,
    },
  };
}
    ...
    <>
      <div className="mt-[70px] mb-20 flex flex-col lg:flex-row h-full w-full lg:items-start sm:items-center justify-center px-4 md:px-6 lg:px-4">
        <div
          ...
          className="order-2 lg:order-1 flex lg:w-[20%] lg:sticky top-0 lg:max-h-[calc(100vh-110px)]overflow-y-auto flex-col w-full no-scrollbar pt-4"
        >
          {/*  <Ads /> */}
