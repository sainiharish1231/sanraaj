...
const Commentsdata = ({
  ...
  return (
    <div>
      <form
        className="relative  flex s-center self-center w-full py-4 overflow-hidden text-gray-600 focus-within:text-gray-400"
      ...
      >
        ...
        <span className="absolute inset-y-0 right-0 flex s-center pr-2">
          <button
            type="submit"
                          ...
                          {editCommentId === item.id && (
                            <div className=" items-center ">
                              <button
                                ...
                                className="flex justify-center items-center dark:text-[#121212] text-[#ffffff] h-7 w-[70px] bg-[#121212] dark:bg-white border-b "
                              >
                                Edit
                              </button>
                              <button
                                onClick={() => handleDeleteComment(item.id)}
                                className="flex justify-center items-center dark:text-[#121212] text-[#ffffff] h-7  w-[70px] bg-[#121212] dark:bg-white"
                              >
                                Delete
                              </button>
                            </div>
